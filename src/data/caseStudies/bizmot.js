  ...
  flows: [
    {
      ...
      screens: [
        { n: "01", label: "Name + photo" },
        { n: "02", label: "Industry + title" },
        { n: "03", label: "Contact details" },
        { n: "04", label: "4 fields, 1 screen", accent: true },
        { n: "05", label: "More insight" },
        { n: "06", label: "Showcase" },
        { n: "07", label: "Choose template", accent: true },
        { n: "08", label: "card, finally", accent: true },
      ],
    },
    {
      tab: "Flow 2",
      ...
      screens: [
        { n: "01", label: "Name + photo" },
        { n: "02", label: "Industry" },
        { n: "03", label: "Job position" },
        { n: "04", label: "Phone" },
        { n: "05", label: "Email" },
        { n: "06", label: "Business info · 2 screens" },
        { n: "07", label: "More insight" },
        { n: "08", label: "Showcase" },
        { n: "09", label: "Choose template", accent: true },
        { n: "10", label: "card, finally", accent: true },
      ],
    },
    {
      tab: "Flow 3 · Shipped",
      ...
      screens: [
        { n: "01", label: "Name + photo" },
        { n: "02", label: "Industry" },
        { n: "03", label: "Choose template — suggests by industry", accent: true },
        { n: "04", label: "Job position" },
        { n: "05", label: "Phone" },
        { n: "06", label: "Email" },
        { n: "07", label: "Business info · 2 screens" },
        { n: "08", label: "More insight" },
        { n: "09", label: "Showcase" },
        { n: "10", label: "card, already seen", accent: true },
      ],
    },
  ],
  defaultFlow: 2,
